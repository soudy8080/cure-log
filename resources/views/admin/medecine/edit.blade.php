            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                    <form method="POST" action="{{ route('medecine.update', $medecine->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                          <div class="col-md-5">
                      ...
                      <div class="row">
                          <div class="col-md-5">
                              ...
                              <input type="text" class="form-control" name="desc" value="{{$medecine->Description}}">
                                  <br>
                              </div>        
                          </div>
                      </div>
